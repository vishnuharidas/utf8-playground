    ...
    return (
        <div className={`${props.className} overflow-y-auto`}>
            ...
            <div className="text-grey-700 text-md space-y-3">
                ...
                <p>The remaining bits in the main byte, along with the bits in the continuation bytes, are combined to form the character's code point. A code point serves as a unique identifier for a character in the Unicode character set.</p>
                <h3 className="text-2xl font-bold mt-6">Example: Hindi Letter "अ" <span className="text-blue-600 text-lg font-light hover:underline cursor-pointer" onClick={() => props.onClick && props.onClick(0xE0A48500)}>(click to load)</span></h3>
                <p>
                    The Hindi letter "अ" is represented in UTF-8 as:
                </p>
                ...
                <ul className="list-disc list-inside ml-4 space-y-2">
                    ...
                    <li>
                        ...
                        are combined to form the binary sequence <code>00001001 00000101</code>, which corresponds to the code point <code>0x0905</code>.
                    </li>
                    <li>
                        The code point <code>U+0905</code> represents the Hindi letter "अ" in the Unicode character set.
                    </li>
                </ul>

                <h3 className="text-2xl font-bold mt-6">Sample Code Blocks</h3>
                <p>
                    Unicode characters are grouped into blocks, each containing a range of code points representing specific sets of characters. Below are some examples of code blocks. Click on any block to load the first recognizable character in that block.
                </p>
                <ul className="list-disc list-inside mt-4">
                    {[
                        ...
                        { name: "Latin Extended-A", start: 3296722944, block: "U+0100..U+017F", official_chart: "https://www.unicode.org/charts/PDF/U0100.pdf" },
                        { name: "Greek and Coptic", start: 3450863616, block: "U+0370..U+03FF", official_chart: "https://www.unicode.org/charts/PDF/U0370.pdf" },
                        { name: "Cyrillic", start: 3498049536, block: "U+0400..U+04FF", official_chart: "https://www.unicode.org/charts/PDF/U0400.pdf" },
                        { name: "Hebrew", start: 0xD7900000, block: "U+0590..U+05FF", official_chart: "https://www.unicode.org/charts/PDF/U0590.pdf" },
                        { name: "Arabic", start: 3632267264, block: "U+0600..U+06FF", official_chart: "https://www.unicode.org/charts/PDF/U0600.pdf" },
                        ...
                        { name: "CJK Unified Ideographs", start: 3837296640, block: "U+4E00..U+9FFF", official_chart: "https://www.unicode.org/charts/PDF/U4E00.pdf" },
                        ...
                        .map((block) => (
                            <li key={block.name} className="mb-2 group relative">
                                ...
                                <sup className="text-blue-500 text-[10px] hover:underline hover:text-blue-700 ml-2 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity">
                ...
                <p>
                    ...
                    Unicode lookup table source: <a className="text-blue-500 underline hover:text-blue-700" href="https://www.unicode.org/Public/UCD/latest/ucd/UnicodeData.txt">UnicodeData.txt</a>
                </p>
            </div>
        </div>
    );
